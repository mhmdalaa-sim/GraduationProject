...
function DeanWarehouse({item}) {
  ...
  return (
    ...
    <Container style={style}>
          ...
          <Link to={`/DeanWareHouses/${item.id}`}><Button type="submit" style={{float:'left',color:'white', borderRadius: "10px",
            borderStyle:"solid",
