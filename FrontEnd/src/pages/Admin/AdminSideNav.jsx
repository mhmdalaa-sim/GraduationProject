...
function AdminSideNav() {
  ...
  return (
    <>
      ...
      <CDBSidebar textColor="white" backgroundColor=" rgb(68, 138, 229)" maxWidth="350px">
        ...
        <CDBSidebarContent>
          <CDBSidebarMenu>
            ...
            <Nav.Link   icon="fa-solid fa-warehouse" style={navstyle} as={Link} to="/WareHouses" >  المخازن </Nav.Link>
            </CDBSidebarMenuItem>
            <CDBSidebarMenuItem ></CDBSidebarMenuItem>
